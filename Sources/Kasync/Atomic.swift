...
public struct Atomic<Operation: Sendable>: Sendable {
    ...
    public init<R: Sendable>(wrappedValue operation: Operation) where Operation == @Sendable () async -> R {
        let mutex = Mutex()
    ...
    public init<R: Sendable, P1: Sendable>(wrappedValue operation: Operation) where Operation == @Sendable (P1) async -> R {
        let mutex = Mutex()
    ...
    public init<R: Sendable, P1: Sendable, P2: Sendable>(wrappedValue operation: Operation) where Operation == @Sendable (P1, P2) async -> R {
        let mutex = Mutex()
        self.atomicOperation = { @Sendable p1, p2 in
            await mutex.atomic {
                await operation(p1, p2)
            }
        }
    }
    ...
    public init<R: Sendable, P1: Sendable, P2: Sendable, P3: Sendable>(wrappedValue operation: Operation) where Operation == @Sendable (P1, P2, P3) async -> R {
        let mutex = Mutex()
        self.atomicOperation = { @Sendable p1, p2, p3 in
            await mutex.atomic {
                await operation(p1, p2, p3)
            }
        }
    }
    ...
    public init<R: Sendable, P1: Sendable, P2: Sendable, P3: Sendable, P4: Sendable>(wrappedValue operation: Operation) where Operation == @Sendable (P1, P2, P3, P4) async -> R {
        let mutex = Mutex()
        self.atomicOperation = { @Sendable p1, p2, p3, p4 in
            await mutex.atomic {
                await operation(p1, p2, p3, p4)
            }
        }
    }
    ...
    public init<R: Sendable, P1: Sendable, P2: Sendable, P3: Sendable, P4: Sendable, P5: Sendable>(wrappedValue operation: Operation) where Operation == @Sendable (P1, P2, P3, P4, P5) async -> R {
        let mutex = Mutex()
        self.atomicOperation = { @Sendable p1, p2, p3, p4, p5 in
            await mutex.atomic {
                await operation(p1, p2, p3, p4, p5)
            }
        }
    }
    ...
    public init<R: Sendable, P1: Sendable, P2: Sendable, P3: Sendable, P4: Sendable, P5: Sendable, P6: Sendable>(wrappedValue operation: Operation) where Operation == @Sendable (P1, P2, P3, P4, P5, P6) async -> R {
        let mutex = Mutex()
        self.atomicOperation = { @Sendable p1, p2, p3, p4, p5, p6 in
            await mutex.atomic {
                await operation(p1, p2, p3, p4, p5, p6)
            }
        }
    }
    ...
    public init<R: Sendable, P1: Sendable, P2: Sendable, P3: Sendable, P4: Sendable, P5: Sendable, P6: Sendable, P7: Sendable>(wrappedValue operation: Operation) where Operation == @Sendable (P1, P2, P3, P4, P5, P6, P7) async -> R {
        let mutex = Mutex()
        self.atomicOperation = { @Sendable p1, p2, p3, p4, p5, p6, p7 in
            await mutex.atomic {
                await operation(p1, p2, p3, p4, p5, p6, p7)
            }
        }
    }
    ...
    public init<R: Sendable, P1: Sendable, P2: Sendable, P3: Sendable, P4: Sendable, P5: Sendable, P6: Sendable, P7: Sendable, P8: Sendable>(wrappedValue operation: Operation) where Operation == @Sendable (P1, P2, P3, P4, P5, P6, P7, P8) async -> R {
        let mutex = Mutex()
        self.atomicOperation = { @Sendable p1, p2, p3, p4, p5, p6, p7, p8 in
            await mutex.atomic {
                await operation(p1, p2, p3, p4, p5, p6, p7, p8)
            }
        }
    }
    ...
    public init<R: Sendable, P1: Sendable, P2: Sendable, P3: Sendable, P4: Sendable, P5: Sendable, P6: Sendable, P7: Sendable, P8: Sendable, P9: Sendable>(wrappedValue operation: Operation) where Operation == @Sendable (P1, P2, P3, P4, P5, P6, P7, P8, P9) async -> R {
        let mutex = Mutex()
        self.atomicOperation = { @Sendable p1, p2, p3, p4, p5, p6, p7, p8, p9 in
            await mutex.atomic {
                await operation(p1, p2, p3, p4, p5, p6, p7, p8, p9)
            }
        }
    }
